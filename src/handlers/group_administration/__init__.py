from src.consts import BOT_USERNAME
from src.handlers.group_administration.group_funcs import (
    handle_bot_added_to_group,
    handle_bot_removed_group,
    close_game,
    done_game, handle_bot_added_to_supergroup,
)
from src.handlers.group_administration.link_game import (
    handle_bot_promoted_to_admin,
    handle_link_game_command,
    handle_link_game,
    GAME_LINK_PREFIX,
)
from src.handlers.group_administration.member_funcs import (
    handle_player_added_to_group,
    handle_player_left_group,
)
from src.handlers.group_administration.migration import handle_group_migrated
from src.handlers.group_administration.post_game import update_game_post
from src.utils.handler_groups.base_handler_group import BaseHandlerGroup


class GroupAdministrationHandlerGroup(BaseHandlerGroup):
