...
async def handle_bot_added_to_group(
    ...
    await bot.send_message(
        update.chat.id,
        "Привет. Я Сники Бот! Спасибо, что добавил меня. Чтобы я мог работать, "
        "мне нужно получить права администратора. Зайди в список участников. "
        "Сделай долгое нажатие на моем имени и появится кнопка “Сделать админом”. "
        "Нажми на нее и поставь везде галочки.",
    )
